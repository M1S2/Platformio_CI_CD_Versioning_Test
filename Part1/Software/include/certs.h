...
// - #2: in Git Bash: openssl s_client -showcerts -connect github.io
...
// CAUTION: The certificate for github.io is only valid until 2027, so it needs to be updated in time before that !!!
