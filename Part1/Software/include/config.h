...
#define PART2ACTIONHUB_AP_TIMEOUT_MS   60000                // Timeout in ms for the part2 action hub access point. Use 0 to disable the timeout and keep the AP active until it is manually stopped.
